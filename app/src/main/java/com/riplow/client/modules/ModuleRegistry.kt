...
object ModuleRegistry {
    val all = listOf(
        ...
        // Historical WClient release features
        ModuleDefinition("critical_hits", "Criticals", "Combat"),
        ModuleDefinition("reach", "Reach", "Combat"),
        ModuleDefinition("smart_aura", "Smart Aura", "Combat"),
        ModuleDefinition("auto_crystal", "Auto Crystal", "Combat"),
        ModuleDefinition("crystal_aura", "Crystal Aura", "Combat"),
        ModuleDefinition("fast_break", "Fast Break", "World"),
        ModuleDefinition("fast_eat", "Fast Eat", "World"),
        ModuleDefinition("jesus", "Jesus", "Motion"),
        ModuleDefinition("fake_lag", "Fake Lag", "Network"),
        ModuleDefinition("slot_switcher", "Slot Switcher", "Misc"),
        ModuleDefinition("switcher", "Switcher", "Minecraft"),
        ModuleDefinition("tp_container", "TP Container", "World"),
        ModuleDefinition("fake_proxy", "Fake Proxy", "Network"),
        ModuleDefinition("chat_suffix", "Chat Suffix", "Misc"),
        ModuleDefinition("chat_prefix", "Chat Prefix", "Misc"),
        ModuleDefinition("random_string", "Random String", "Misc"),
        ModuleDefinition("scaffold", "Scaffold", "Motion"),
        ModuleDefinition("mod_alert", "Mod Alert", "Misc"),
        ModuleDefinition("anti_void", "Anti Void", "World"),
        ModuleDefinition("nametags", "Nametags", "Visual"),
        ModuleDefinition("armour_esp", "Armour ESP", "Visual"),
        ModuleDefinition("tracer", "Tracer", "Visual"),
        ModuleDefinition("inventory_helper", "Inventory Helper", "Misc"),
        ModuleDefinition("rotation", "Rotation", "Motion"),
        ModuleDefinition("x_strafe", "X Strafe", "Motion"),
        ModuleDefinition("eps", "EPS", "Visual"),
        ModuleDefinition("crasher", "Crasher", "Misc"),
        ModuleDefinition("blink", "Blink", "Network"),
        ModuleDefinition("fast_stop", "Fast Stop", "Motion"),
        ModuleDefinition("advance_disabler", "Advance Disabler", "Network"),
        ModuleDefinition("java_aura", "Java Aura", "Combat"),
        ModuleDefinition("chat_spammer", "Chat Spammer", "Misc"),
        ModuleDefinition("player_logs", "Player Logs", "Visual"),
        ModuleDefinition("critical_hit", "Critical Hit", "Combat"),
        ModuleDefinition("tp_mine_legacy", "TP Mine Legacy", "World"),
